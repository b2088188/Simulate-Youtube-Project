...
const ListGroupItem = styled.div`
  ...
  ${(props) => props.p15 && setFlexWidth({ width: '15' })}
   ...
   ${({flexWidth}) => flexWidth &&flexWidth.phone ? media.phone(setFlexWidth({width: flexWidth.phone})) : null}
    ...
    // margin horizontal
    ${({spacing}) => spacing && typeof spacing === 'string' ? setMargin({x: `${spacing}%`,
          y: 0}) : null}
 ${({spacing}) => spacing&&spacing.desktop  ? setMargin({x: `${spacing.desktop}%`,
          y: 0}) : null}
   ${({spacing}) => spacing&&spacing.tabland ? media.tabland(setMargin({x: `${spacing.tabland}%`,
          y: 0}))  : null}
   ${({spacing}) => spacing&&spacing.tabport ? media.tabport(setMargin({x: `${spacing.tabport}%`,
          y: 0})) : null}
   ${({spacing}) => spacing&&spacing.phone ? media.phone(setMargin({x: `${spacing.phone}%`,
          y: 0})) : null}
    // margin vertical
    ${({mx}) => mx && typeof mx === 'string' ? setMargin({x: mx,
          y: 0}) : null}
 ${({mx}) => mx&&mx.desktop  ? setMargin({x: mx.desktop,
          y: 0}) : null}
   ${({mx}) => mx&&mx.tabland ? media.tabland(setMargin({x: mx.tabland,
          y: 0}))  : null}
   ${({mx}) => mx&&mx.tabport ? media.tabport(setMargin({x: mx.tabport,
          y: 0})) : null}
   ${({mx}) => mx&&mx.phone ? media.phone(setMargin({x: mx.phone,
          y: 0})) : null}
    // margin-bottom
