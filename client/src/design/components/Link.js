...
${({pdXY}) => pdXY && typeof pdXY === 'object' ? setPadding({x: pdXY.x,
 ...
 ${({pdXY}) => pdXY&&pdXY.desktop  ? setPadding({x: pdXY.desktop.x,
   ...
   // Flex & align-items
   ${({alignItems}) => alignItems && typeof alignItems === 'string' ? setFlex({y: alignItems}) : null}
   ${({alignItems}) => alignItems && alignItems.desktop ? setFlex({y: alignItems.desktop}) : null}
   ${({alignItems}) => alignItems &&alignItems.tabland ? media.tabland(setFlex({y: alignItems.tabland}))  : null}
   ${({alignItems}) => alignItems &&alignItems.tabport ? media.tabport(setFlex({y: alignItems.tabport})) : null}
   ${({alignItems}) => alignItems &&alignItems.phone ? media.phone(setFlex({y: alignItems.phone})) : null}
    // flex-basis
